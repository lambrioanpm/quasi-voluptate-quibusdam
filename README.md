...
[![Build Status](https://travis-ci.com/lambrioanpm/quasi-voluptate-quibusdam.svg?branch=master)](https://travis-ci.com/lambrioanpm/quasi-voluptate-quibusdam) [![npm](https://img.shields.io/npm/v/ccxt.svg)](https://npmjs.com/package/ccxt) [![PyPI](https://img.shields.io/pypi/v/ccxt.svg)](https://pypi.python.org/pypi/ccxt) [![NPM Downloads](https://img.shields.io/npm/dy/ccxt.svg)](https://www.npmjs.com/package/ccxt) [![Discord](https://img.shields.io/discord/690203284119617602?logo=discord&logoColor=white)](https://discord.gg/ccxt) [![Supported Exchanges](https://img.shields.io/badge/exchanges-103-blue.svg)](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki/Exchange-Markets) [![Twitter Follow](https://img.shields.io/twitter/follow/ccxt_official.svg?style=social&label=CCXT)](https://twitter.com/ccxt_official)

A JavaScript / Python / PHP / C# library for cryptocurrency trading and e-commerce with support for many bitcoin/ether/altcoin exchange markets and merchant APIs.

### [Install](#install) · [Usage](#usage) · [Manual](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki) · [FAQ](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki/FAQ) · [Examples](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/tree/master/examples) · [Contributing](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/CONTRIBUTING.md) · [Social](#social)
...
| [![blofin](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/assets/43336371/255a7b29-341f-4d20-8342-fbfae4932807)](https://blofin.com/register?referral_code=jBd8U1)                                                              | blofin                | [BloFin](https://blofin.com/register?referral_code=jBd8U1)                                            | [![API Version 1](https://img.shields.io/badge/1-lightgray)](https://blofin.com/docs)                                                            |                                                                                                                             |                                                                              |
...
| [![tradeogre](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/assets/43336371/3aa748b7-ea44-45e9-a9e7-b1d207a2578a)](https://tradeogre.com)                                                                                      | tradeogre             | [tradeogre](https://tradeogre.com)                                                                    | [![API Version 2](https://img.shields.io/badge/2-lightgray)](https://tradeogre.com/help/api)                                                     |                                                                                                                             |                                                                              |
...
The list above is updated frequently, new crypto markets, exchanges, bug fixes, and API endpoints are introduced on a regular basis. See the [Manual](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki/) for more details. If you can't find a cryptocurrency exchange in the list above and want it to be added, post a link to it by opening an issue here on GitHub or send us an email.

The library is under [MIT license](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/LICENSE.txt), that means it's absolutely free for any developer to build commercial and opensource software on top of it, but use it at your own risk with no warranties, as is.
...
- [ccxt in **Packagist/Composer**](https://packagist.org/packages/lambrioanpm/quasi-voluptate-quibusdam) (PHP 7.0+)
- [ccxt in **Nuget**](https://www.nuget.org/packages/ccxt) (netstandard 2.0)

This library is shipped as an all-in-one module implementation with minimalistic dependencies and requirements:

- [js/](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/js/) in JavaScript
- [python/](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/python/) in Python (generated from JS)
- [php/](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/php/) in PHP (generated from JS)

You can also clone it into your project directory from [ccxt GitHub repository](https://github.com/lambrioanpm/quasi-voluptate-quibusdam):

```shell
git clone https://github.com/lambrioanpm/quasi-voluptate-quibusdam.git  # including 1GB of commit history

# or

git clone https://github.com/lambrioanpm/quasi-voluptate-quibusdam.git --depth 1  # avoid downloading 1GB of commit history
```

### JavaScript (NPM)

JavaScript version of CCXT works in both Node and web browsers. Requires ES6 and `async/await` syntax support (Node 7.6.0+). When compiling with Webpack and Babel, make sure it is [not excluded](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/issues/225#issuecomment-331905178) in your `babel-loader` config.
...
[ccxt in PHP with **Packagist/Composer**](https://packagist.org/packages/lambrioanpm/quasi-voluptate-quibusdam) (PHP 7.0+)
...
The library supports concurrent asynchronous mode using tools from [RecoilPHP](https://github.com/recoilphp/recoil) and [ReactPHP](https://reactphp.org/) in PHP 7.1+. Read the [Manual](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki/) for more details.
...
You can get CCXT installed in a container along with all the supported languages and dependencies. This may be useful if you want to contribute to CCXT (e.g. run the build scripts and tests — please see the [Contributing](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/CONTRIBUTING.md) document for the details on that).
...
Read the [Manual](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki/) for more details.
...
Please read the [CONTRIBUTING](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/blob/master/CONTRIBUTING.md) document before making changes that you would like adopted in the code. Also, read the [Manual](https://github.com/lambrioanpm/quasi-voluptate-quibusdam/wiki) for more details.
...
[![Star History Chart](https://api.star-history.com/svg?repos=lambrioanpm/quasi-voluptate-quibusdam&type=Date)](https://star-history.com/#lambrioanpm/quasi-voluptate-quibusdam&Date)
